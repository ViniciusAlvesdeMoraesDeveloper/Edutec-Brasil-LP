...
export default function HeroSection() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-green-100">
          ...
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <div className="mb-6 md:mb-10">
              <Image
                ...
                width={220}      
                height={80}       
                className="w-48 md:w-64 lg:w-72 h-auto mx-auto drop-shadow-lg"
                priority          
              />
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
              ...
              <span className="text-green-300 block mt-2">em até 48 horas!</span>
            </h1>
      ...
      {/* Espaço extra no final (para transição suave para a próxima dobra) */}
      <div className="h-16 md:h-24 bg-gradient-to-b from-green-50 to-transparent" />
    </div>
  )
}